...
const exactJobs: JobSignal[] = [
  ...
  },
  {
    ...
    experience: "社招 · 本科及以上",
    match: 96,
    keywords: ["Agent", "API", "CLI", "Skill", "工程基础"],
    source: "https://talent.baidu.com/jobs/detail/SOCIAL/a5ff8d15-b547-4a87-ba55-a128dae953cd",
    sourceLabel: "百度官方职位详情",
    evidenceLevel: "精确 JD",
    jobId: "J103341",
    ...
    captured: "2026-09-06",
    status: "官网可访问",
    summary: "建设 API、CLI 与 Skill 全链路工具和 Agent-friendly 基础设施，强调系统设计、抽象与工程基本功。",
  },
  {
    id: "baidu-j97670",
    company: "百度",
    title: "AI Coding 应用研发实习生",
    role: "AI Coding 工具",
    location: "北京",
    salary: "官网未公开",
    salaryNote: "实习薪资以招聘方沟通为准。",
    experience: "实习 · 本科及以上",
    match: 91,
    keywords: ["AI Coding", "Prompt", "RAG", "Agent", "LangGraph"],
    source: "https://talent.baidu.com/jobs/detail/INTERN/d1ed3134-5bd8-4743-a937-acca2773b1e7",
    sourceLabel: "百度官方职位详情",
    evidenceLevel: "精确 JD",
    jobId: "J97670",
    published: "2026-07-21",
    captured: "2026-09-06",
    status: "官网可访问",
    summary: "要求计算机基础、软件流程和产品逻辑，并把 Prompt、RAG、Agent 与 LangGraph 用于研发场景。",
  },
  {
    id: "baidu-j101345",
    company: "百度",
    title: "大模型 Agent 算法实习生",
    role: "Agent 应用工程",
    location: "北京",
    salary: "官网未公开",
    salaryNote: "实习薪资以招聘方沟通为准。",
    experience: "实习 · 本科及以上",
    match: 84,
    keywords: ["Router", "Plan", "Retrieval", "Tool Use", "评测"],
    source: "https://talent.baidu.com/jobs/detail/INTERN/1a0bfe96-f59c-4384-9525-79fdf324c67f",
    sourceLabel: "百度官方职位详情",
    evidenceLevel: "精确 JD",
    jobId: "J101345",
    published: "2026-07-21",
    captured: "2026-09-06",
    status: "官网可访问",
    summary: "覆盖路由、规划、检索、工具使用、Deep Research 和评测闭环，偏算法与 Agent 能力建设。",
  },
  {
    id: "baidu-j101017",
    company: "百度",
    ...
    experience: "校招 · 本科及以上",
    match: 93,
    keywords: ["ReAct", "Plan-execute", "Tool", "Memory", "Eval"],
    source: "https://talent.baidu.com/jobs/detail/GRADUATE/02f73086-be71-4d09-8d6e-f1c6981b8b48",
    sourceLabel: "百度官方职位详情",
    evidenceLevel: "精确 JD",
    jobId: "J101017",
    published: "2026-07-21",
    captured: "2026-09-06",
    status: "官网可访问",
    summary: "设计 ReAct、CoT、Plan-execute、工具、记忆与多 Agent 系统，并建设 Agent 评测体系。",
  },
  {
    id: "baidu-j102217",
    company: "百度",
    ...
    experience: "社招 · 硕士及以上优先",
    match: 78,
    keywords: ["训练", "评测", "RAG", "Agent", "多模态"],
    source: "https://talent.baidu.com/jobs/detail/SOCIAL/f16d38a1-440b-4e7b-b09b-ddfdfaf643e4",
    sourceLabel: "百度官方职位详情",
    evidenceLevel: "精确 JD",
    jobId: "J102217",
    published: "2026-07-21",
    captured: "2026-09-06",
    status: "官网可访问",
    summary: "同时覆盖模型训练、应用、评测、RAG、Agent、工具和多模态，适合判断算法岗的额外学习深度。",
  },
];
...
export const interviewEvidence: InterviewEvidence[] = [
  ...
  ["n08", "2026 大模型应用岗位面试复盘", "https://www.nowcoder.com/discuss/914178628659707904", "2026-08", "面经汇总", ["Agent", "RAG", "MCP", "上下文", "安全", "评测", "后端"]],
  ...
  ["n49", "大模型应用岗位高频题单", "https://www.nowcoder.com/discuss/922460229782671360", "2026-08", "面经汇总", ["Agent", "RAG", "MCP", "可靠性", "评测"]],
  ["n50", "Agent 应用 / 平台 / 算法岗位面试复盘", "https://www.nowcoder.com/discuss/916347378695692288", "2026-08", "真实面经", ["项目深挖", "Agent", "RAG", "安全", "上下文", "后端"]],
