...
type SiteTheme = "career" | "ide-native";
...
const tabs: {
  ...
  { id: "home", label: "转型工作台", ideLabel: "Dashboard", icon: "⌂", short: "总览", ideShort: "Dashboard", fileName: "dashboard.tsx" },
  { id: "roadmap", label: "学习路线", ideLabel: "Knowledge Tree", icon: "▤", short: "路线", ideShort: "Knowledge", fileName: "knowledge.route.ts" },
  { id: "roles", label: "岗位机会", ideLabel: "Opportunity Log", icon: "⌁", short: "岗位", ideShort: "Signals", fileName: "opportunities.json" },
  { id: "interview", label: "面试训练", ideLabel: "Interview Console", icon: "▣", short: "面试", ideShort: "Console", fileName: "interview.spec.ts" },
  { id: "practice", label: "刻意练习", ideLabel: "Practice Lab", icon: "☆", short: "练习", ideShort: "Practice", fileName: "practice.md" },
];
...
export default function Home() {
  ...
  const [siteTheme, setSiteTheme] = useState<SiteTheme>("ide-native");
  ...
  useEffect(() => {
    ...
    const storedTheme = safeRead<string>("frontend-ai-theme-v1", "ide-native");
    setSiteTheme(storedTheme === "career" ? "career" : "ide-native");
  }, []);
  ...
  const activePageLabel = siteTheme === "ide-native" ? activePage.ideLabel : activePage.label;
  ...
  return (
    <div className={`app theme-${siteTheme}${siteTheme === "ide-native" ? " theme-ide" : ""}${siteTheme === "ide-native" && !ideExplorerOpen ? " explorer-collapsed" : ""}`}>
      <aside className="global-nav">
        ...
        >
          <span>{siteTheme === "ide-native" ? "</>" : "F"}</span>
        </button>
        <nav className="tab-bar" role="tablist" aria-label="网站模块">
          {tabs.map((tab) => (
            <button
              ...
              title={siteTheme === "ide-native" ? tab.ideLabel : tab.label}
            >
              <span aria-hidden="true">{tab.icon}</span>
              <em>{siteTheme === "ide-native" ? tab.ideShort : tab.short}</em>
            </button>
          ))}
        </nav>
        <button
      ...
      <header className="dashboard-header">
        <div className="dashboard-title">
          <span>{siteTheme === "ide-native" ? "frontend-ai-universal" : "Frontend → AI"}</span>
        ...
        <div className="dashboard-header-actions">
          ...
          <div className="global-search">
            ...
            <input
              ...
              placeholder={siteTheme === "ide-native" ? "Search workspace…" : "搜索知识、岗位、题目"}
