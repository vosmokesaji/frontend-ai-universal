...
export const knowledge: Knowledge[] = [
  ...
  },
  {
    ...
    phase: "31—60 天",
    category: "应用",
    name: "模型 API、上下文工程与结构化输出",
    why: "提示词技巧正在商品化，但输入契约、动态上下文、工具说明、结构化输出与失败策略仍决定生产效果。",
    outcome: "建立可版本化指令、结构化输出、上下文选择与压缩、缓存和模型路由。",
    importance: 5,
    difficulty: 2,
    days: 10,
    fit: 94,
  ...
  },
  {
    ...
    category: "工程",
    name: "AI 协作开发、规格与验证",
    why: "编码 Agent 已能接手越来越长的实现任务，人的工作重心正在移到定义问题、提供上下文、拆分任务和验证结果。",
    outcome: "能把需求写成可执行规格，用测试和代码审查约束 Agent，并保留可复现的提交与评测记录。",
    importance: 5,
    difficulty: 3,
    days: 12,
    fit: 98,
    resources: [
      {
        ...
        lang: "英文",
        note: "围绕代码库探索、计划、测试、提交和可验证任务学习 Agent 协作方式。",
      },
      {
        title: "The new identity of a developer",
        provider: "GitHub",
        url: "https://github.blog/news-insights/octoverse/the-new-identity-of-a-developer-what-changes-and-what-doesnt-in-the-ai-era/",
        lang: "英文",
        note: "把开发者的新职责归纳为理解工作、指挥工作和验证工作。",
      },
      {
        title: "Build an optimized review process with Copilot",
        provider: "GitHub",
        url: "https://docs.github.com/en/copilot/tutorials/optimize-code-reviews",
        lang: "英文",
        note: "把仓库指令、自动审查和人工判断组合成可落地的评审流程。",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    category: "前端",
    name: "现代全栈与服务端边界",
    why: "端到端交付能力值得补齐，但 Next.js 只是实现选项，不应被当作转向 AI 的前置门槛。",
